...
What if the p-value of a test is \< .01? We should report it as "p \<
.01". Below is a more flexible version of our code that implements
this.
...
paste0("*t* (", 
  ...
  ", *p* ", 
  ifelse(result_t$p.value < 0.001, "< 0.001", 
  ifelse(result_t$p.value < 0.01, "<.01",
